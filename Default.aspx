<%@ Page Title="Default" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="_Default" %>
                ...
                <div class="col-md-12">
                    ...
                    <asp:GridView id="grdAluno" runat="server" CssClass="table table-bordered" PagerStyle-CssClass="paginacao" AllowSorting="True" AllowPaging="True" PageSize="20" AutoGenerateColumns="False" DataKeyNames="CI01_ID_ALUNO">
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="CI01_ID_ALUNO" DataNavigateUrlFormatString="frmTesteCadastro.aspx?id={0}" HeaderText="documentos" Text="Selecionar Alunos" />
